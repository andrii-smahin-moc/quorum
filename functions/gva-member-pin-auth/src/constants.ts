...
export const PHRASES = {
  CANCEL: ['cancel', 'exit', 'stop', 'quit', 'never mind', 'goodbye'],
  FORGOT_CREDENTIALS: [
    "i don't know",
    "don't know",
    'i forgot',
  ...
  REQUEST_HUMAN: ['speak to someone', 'talk to a person', 'live agent', 'human', 'representative', 'transfer me', 'connect me', 'support'],
} as const;
